...
namespace Market.Migrations
{
    ...
    [Migration("20241110183458_someColumnsinCart_CartItem")]
    partial class someColumnsinCart_CartItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Market.Model.Store", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Market.Model.Cart", b =>
                {
                    b.HasOne("Model.Client.Client", "client")
                        .WithOne("cart")
                        .HasForeignKey("Market.Model.Cart", "ClientId")
            ...
            modelBuilder.Entity("Market.Model.Product", b =>
                {
                    b.HasOne("Market.Model.Store", "store")
                        .WithMany("Products")
